<template>
  <div class="SentTheCount">
    ...
    <div class="SentTheCount-content">
      <div class="top">
      ...
      <div class="content">
        <div class="item">
          ...
          <div class="item-right">
            <div class="title">
              <div class="name">接收境外遣返人员</div>
              <div class="value">4028</div>
            </div>
            <div class="text">
        ...
        <div class="item">
          ...
          <div class="item-right">
            ...
            <div class="text">
              <div class="t flex flex-between align-center">
                <div class="flex-start flex align-center">
                  <i class="iconfont icon-shangsheng"></i>
                  <div>同比</div>
                </div>
              ...
              <div class="h flex flex-between align-center">
                <div class="flex-start flex align-center">
                  <i class="iconfont icon-shangsheng"></i>
                  <div>环比</div>
                </div>
