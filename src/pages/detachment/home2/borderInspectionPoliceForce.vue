...
import apiJson from "../../../../public/apiJson/borderInspectionPoliceForce"
...
const open = (style) => emit('open', {style, el: 'borderInspectionPoliceForce'})
...
const renderChart = () => {
  ...
  apiJson.data.policeForces.map((index)=>{option.title.text +=index.value})
  ...
  apiJson.data.equipmentUsed.map((index)=>{option.title.text +=index.value})
  ...
  apiJson.data.portsNumber.map((index)=>{option.title.text  +=index.value})
    ...
    .item {
      ...
      &-footer {
        ...
        .left, .content, .right {
          ...
          height: 75px;
          display: grid;
          grid-template-columns: 0 300px 100px 110px auto;
          font-size: 40px;
          margin: 5px auto;
        }
        ...
        .left {
          ...
          &:nth-child(4) {
            ...
            &:before {
              ...
              width: 7px;
              height: 7px;
              background-color: rgba(237, 157, 34, 0.1);
              position: relative;
              top: -45px;
              left: -25px;
            }
