<template>
  <div class="BorderChecks">
    <z-title title="边境检查" @click="open"></z-title>
    <div class="legend">
    ...
    <div class="BorderChecks-content">
      <div v-for="(item,index) in listdata" class="item">
        <div class="item-left">
          <img src="../../../assets/img/page/borderSafety/b1.png" alt=""/>
        </div>
...
const renderChart = () => {
  const charts = proxy.$echarts.init(BorderChecksEcharts.value)
  let option = {
        ...
        .top {
          ...
          .flag {
            ...
            &::before {
              ...
              width: 11px;
              border-radius: 50%;
              border: 8px solid rgba(181, 225, 245, 1);
            }
          }
