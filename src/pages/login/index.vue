...
async function loginFun() {
  ...
  if (pageConfigs.isRequest) res = await login(parameter)
    ...
    "data": {
      ...
      "yhtx":"",
      "yhbh":"yuzs",
      "logmq":"imos.exchange.log",
      "sjjgmc":"边防检查管理司",
      "token":"eyJoeXAioiJKV1QiLCJhbGcioiJIUzI1NiJ9.eyJpc3Mi0iJpbW9zIiwiZXhwIjoxNjY4MTYzMjA0LCJ1c2VyawQi0iJ5dXpzIiwiaWFOIjoxNiY3NTU4NDA0F0dhicsoij6108gbaekFv-3WWOOxVCEJroLwOgSFnJjoA",
      "jgbh":"820000000000",
      "jgsx":"13SWCS",
      "dlsb":"web",
      "jglx":"1",
