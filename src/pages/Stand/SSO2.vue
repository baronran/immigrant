...
import essentialInformation from "../../components/pages/SSO/essentialInformation.vue";
//  疫情防控专题
...
//  遣返遣送人员统计
// import SentTheCount from '../../components/pages/SSO/SentTheCount.vue'
//  重要案件播报
// import importantCases from '../../components/pages/SSO/importantCases.vue'

//  违法事件趋势
// import trendOffenders from '../../components/pages/SSO/trendOffenders.vue'
...
.pages {
  ...
  &-left {
    ...
    &-card1 {
      display: grid;
      grid-template-rows: 1121px 1155px 1198px;
      grid-row-gap: 120px;
    }
