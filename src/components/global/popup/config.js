...
export const bureauPopup = [
  ...
  // SOEAEA
  {
    ...
    '出入境证件签发': defineAsyncComponent(() => import(`../../pages/SOEAEA2/ImmigrationClearance.vue`)),
    '签注签发': defineAsyncComponent(() => import(`../../pages/SOEAEA2/ImmigrationClearance2.vue`)),
    '港澳台区域证件签发': defineAsyncComponent(() => import(`../../pages/SOEAEA2/ImmigrationClearance3.vue`)),
    '外国人证件签发数Top10': defineAsyncComponent(() => import(`../../pages/SOEAEA2/top10.vue`)),
    '境内常驻外国人': defineAsyncComponent(() => import(`../../pages/SOEAEA2/domesticResidentAlien.vue`)),
    '要情信息': defineAsyncComponent(() => import(`../../pages/SSO2/essentialInformation.vue`)),
    '舆情动态': defineAsyncComponent(() => import(`../../pages/SSO2/feelings.vue`)),
    '值班领导': defineAsyncComponent(() => import(`../../pages/SSO2/duty.vue`)),
    '重要案事件播报': defineAsyncComponent(() => import(`../../pages/SSO2/importantCases.vue`)),
...
export const standPopup = [
  // SSO
  {
    '出入境人员检查': defineAsyncComponent(() => import(`../../pages/SSO2/ImmigrationClearance.vue`)),
    '出入境交通工具检查': defineAsyncComponent(() => import(`../../pages/SSO2/ImmigrationClearance2.vue`)),
    '边防检查执勤警力': defineAsyncComponent(() => import(`../../pages/SSO2/Bipod.vue`)),
    '边境辖区执勤警力': defineAsyncComponent(() => import(`../../pages/SSO2/borderManagement.vue`)),
    '边境管理态势': defineAsyncComponent(() => import(`../../pages/SSO2/borderManagementSituation.vue`)),
    '要情信息': defineAsyncComponent(() => import(`../../pages/SSO2/essentialInformation.vue`)),
    '舆情动态': defineAsyncComponent(() => import(`../../pages/SSO2/feelings.vue`)),
    '值班领导': defineAsyncComponent(() => import(`../../pages/SSO2/duty.vue`)),
