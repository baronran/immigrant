...
import layoutHeader from './layoutHeader/template2.vue'
...
const handleBall = (index) => {
  if (index == 0) setTimeout(() => maps.value.airline(), 500)
  else setTimeout(() => maps.value.initFace(), 500)
}
