<template>
  <div class="pages-head">
    <div class="pages-head-left">
      <router-link :class="[pageIndex==0?'on':'']" class="nav" to="/Stand/SSO">勤务态势总览</router-link>
      <router-link :class="[pageIndex==1?'on':'']" class="nav" to="/Stand/PLES">口岸执法执勤态势</router-link>
    </div>
    ...
    <div class="pages-head-right">
      <router-link :class="[pageIndex==2?'on':'']" class="nav" to="/Stand/SCSIBJ">边境辖区安全管控态势</router-link>
      <router-link :class="[pageIndex==3?'on':'']" class="nav" to="/Stand/SOEAEA">出入境管理部门数据统计</router-link>
    </div>
  </div>
</template>
