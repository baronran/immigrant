...
let toplist = ref([
{label:'内地居民赴香港签注',num:982,point:5},
{label:'内地居民赴澳门签注',num:22210,point:5},
{label:'内地居民赴台湾签注',num:213,point:5},
])
...
.topBox{
  ...
  .exitEntry {
    background-image: url("@/assets/img/page/SSO/501679.png");
